...
public class ConfigUtils {
	 ...
	 *            key to read
	 * @param defaultValue
	 *            default array of result
	 * @param seperator
	 *            regex. optional, if null or empty ; will be used.
	 * @return list of strings
	 */
	public static String[] readList(String key, String[] defaultValue,
			String seperator) {
	 ...
	 * @param name
	 *            name of key
	 * @param defaultImplemntation
	 *            default instance, if fails to load
	 * @param <T>
	 *            type
	...
	public static <T> T getInstance(String name, T defaultImplemntation) {
		try {
			BeanDeclaration decl = new XMLBeanDeclaration(
					(HierarchicalConfiguration) config, name);
