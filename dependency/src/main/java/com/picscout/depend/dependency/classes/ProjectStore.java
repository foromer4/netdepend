...
/**
 * Save projects mapped by guid and also mapped by assembly name, enable to
 * query for projects by those keys.
 * 
 * @see IProjectStore
 * @author OSchliefer
 *
...
public class ProjectStore implements IProjectStore {
	 ...
	 * 
	 * @see
	 * com.picscout.depend.dependency.IProjectStore#addProject(com.picscout.
	 * depend.dependency.IProject)
	 */
	public void addProject(IProject project) {
		projectByGuid.put(project.getDescriptor().getGuid(), project);
		projectByAssembly.put(project.getDescriptor().getAssemblyName(),
				project);
	}
	 ...
	 * 
	 * @see
	 * com.picscout.depend.dependency.IProjectStore#getProjectByGuid(java.lang
	 * .String)
	 */
	 ...
	 * 
	 * @see
	 * com.picscout.depend.dependency.IProjectStore#getProjectByAssemblyName
	 * (java.lang.String)
	 */
