...
public class SolutionTest {
	...
	private List<IProjectDescriptor> createProjectDescriptors() {
		...
		list.add(new ProjectDescriptor("C:\\git\\netdepend\\dependency\\target\\test-classes\\picscout.it.priorityq\\picscout.it.priorityq.csproj", "picscout.it.priorityq", "27b0461c-5d5c-4406-9a1d-564717778b8c", null));
		list.add(new ProjectDescriptor("C:\\git\\netdepend\\dependency\\target\\test-classes\\tests", "tests", "4567d585-5619-4e27-9198-f86e9d1d08bf", null));
		list.add(new ProjectDescriptor("C:\\git\\netdepend\\dependency\\target\\test-classes\\picscout.it.priorityq.integration\\picscout.it.priorityq.integration.csproj", "picscout.it.priorityq.integration", "13257306-02d0-496e-9b47-eb4d5914606c", null));
		list.add(new ProjectDescriptor("C:\\git\\netdepend\\dependency\\target\\test-classes\\picscout.it.priorityq.test\\picscout.it.priorityq.test.csproj", "picscout.it.priorityq.test", "2130d535-50cc-497e-b1e9-768e24d81ee9", null));
		return list;
	}
